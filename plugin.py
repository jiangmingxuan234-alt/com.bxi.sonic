...
from .zerolab.state import ZeroLabArmedTeleopState
...
def _common_state_kwargs(state: StateBuildContext) -> dict[str, object]:
    return {
        ...
        "gripper_calibration_kp": state.float_param(
            "gripper_calibration_kp", 5.0
        ),
        "gripper_calibration_kd": state.float_param(
